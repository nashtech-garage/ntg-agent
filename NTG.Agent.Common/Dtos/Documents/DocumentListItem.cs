...
public record DocumentListItem (Guid Id, string Name, DateTime CreatedAt, DateTime UpdatedAt, List<string> Tags, DocumentStatus Status, string? ErrorMessage, string? UploadedViaAgentName = null)
{

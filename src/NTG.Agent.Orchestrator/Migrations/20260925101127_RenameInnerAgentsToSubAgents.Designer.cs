...
namespace NTG.Agent.Orchestrator.Migrations
{
    ...
    [Migration("20260925101127_RenameInnerAgentsToSubAgents")]
    partial class RenameInnerAgentsToSubAgents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NTG.Agent.Orchestrator.Models.Agents.AgentSubAgent", b =>
                {
                    b.Property<Guid>("AgentId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NTG.Agent.Orchestrator.Models.Agents.AgentSubAgent", b =>
                {
                    b.HasOne("NTG.Agent.Orchestrator.Models.Agents.Agent", "Agent")
                        .WithMany("SubAgentBindings")
                        .HasForeignKey("AgentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NTG.Agent.Orchestrator.Models.Agents.Agent", "SubAgent")

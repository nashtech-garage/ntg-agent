...
public record AgentListItem (Guid Id, string Name, string OwnerEmail, string UpdatedByEmail, DateTime UpdatedAt, bool IsDefault, bool IsPublished, AgentKind AgentKind = AgentKind.Outer, AgentProvisioningStatus ProvisioningStatus = AgentProvisioningStatus.Ready, string? ProvisioningError = null, string? ProviderName = null)
{

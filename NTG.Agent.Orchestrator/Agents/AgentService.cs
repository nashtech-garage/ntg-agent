...
public class AgentService
{
    ...
    {
        var agent = _agentFactory.CreateBasicClient("Generate a short, descriptive conversation name (≤ 5 words).");
    ...
    private async Task<string> SummarizeMessagesAsync(List<PChatMessage> messages)
    {
        ...
        var agent = _agentFactory.CreateBasicClient("Summarize the following chat into a concise paragraph that captures key points.");

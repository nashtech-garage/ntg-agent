...
public class AgentFactory : IAgentFactory
{
    ...
    public AgentFactory(IConfiguration configuration, AgentDbContext agentDbContext, AgentAccessService agentAccessService, RenderableToolCapture renderableToolCapture)
    {

...
namespace NTG.Agent.Orchestrator.Migrations
{
    ...
    [Migration("20260707081902_AddEnglishCoachAgent")]
    partial class AddEnglishCoachAgent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NTG.Agent.Orchestrator.Models.Agents.Agent", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("f0b9a7d7-2f4e-4d8f-8c0b-5e3a1e2c4f11"),
                            AgentKind = 0,

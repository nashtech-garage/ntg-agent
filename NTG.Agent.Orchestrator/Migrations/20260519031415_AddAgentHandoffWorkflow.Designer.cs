...
namespace NTG.Agent.Orchestrator.Migrations
{
    ...
    [Migration("20260519031415_AddAgentHandoffWorkflow")]
    partial class AddAgentHandoffWorkflow
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NTG.Agent.Orchestrator.Models.Agents.AgentHandoff", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NTG.Agent.Orchestrator.Models.Agents.AgentHandoff", b =>
                {
                    b.HasOne("NTG.Agent.Orchestrator.Models.Agents.Agent", "SourceAgent")
                        .WithMany("OutgoingHandoffs")
                        .HasForeignKey("SourceAgentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("NTG.Agent.Orchestrator.Models.Agents.Agent", "TargetAgent")
                        .WithMany("IncomingHandoffs")
            ...
            modelBuilder.Entity("NTG.Agent.Orchestrator.Models.Agents.Agent", b =>
                {
                    ...
                    b.Navigation("IncomingHandoffs");

                    b.Navigation("OutgoingHandoffs");
                });
